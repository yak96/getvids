...
def lisensi():
    ...
    res=ses.get('https://app.cryptolens.io/api/key/Activate?token=WyIyMTg3ODY3OSIsIkFnS3RkVysyVXYvazlhSUdnM3ZyZ0FScElYK3p5bDhEQ0NwL1pLdlkiXQ==&ProductId=15854&Key='+lisensikuni[0]).json()
